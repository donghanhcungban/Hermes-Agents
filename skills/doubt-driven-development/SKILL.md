...
description: "Adversarially review high-risk implementation decisions."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [adversarial-review, correctness, safety, verification, high-stakes]
    related_skills: [requesting-code-review, systematic-debugging, evidence-driven-delivery]
---
...
- **`requesting-code-review` / `/review`**: complementary. `/review` is post-hoc PR verdict; doubt-driven is in-flight per-decision. Use both.
