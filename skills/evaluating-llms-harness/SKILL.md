...
metadata:
  hermes:
    tags: [evaluation, lm-eval-harness, benchmarking, mmlu, humaneval, gsm8k]
    related_skills: [weights-and-biases, huggingface-hub]
---
---
...
class EvalHarnessCallback(Callback):
    def on_validation_epoch_end(self, trainer, pl_module):
        ...
        # Run lm-eval
        os.system(f"lm-eval run --model hf --model_args pretrained={checkpoint_path} ...")
```
