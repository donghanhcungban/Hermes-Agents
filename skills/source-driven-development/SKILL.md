...
description: "Ground implementations in official docs, not memory."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [documentation, source-grounded, research, correctness, citations]
    related_skills: [evidence-driven-delivery, requesting-code-review]
---
