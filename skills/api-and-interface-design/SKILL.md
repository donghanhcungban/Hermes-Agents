...
description: "Design stable APIs, contracts, and module boundaries."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [api-design, rest, graphql, contracts, module-boundaries, interfaces]
    related_skills: [architecture-patterns, evidence-driven-delivery]
---
...
- **Plan for deprecation at design time.** Apply a versioning and deprecation strategy to safely remove things users depend on.
