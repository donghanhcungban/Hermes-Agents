...
description: "Organize Python projects, modules, and public APIs."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [python, project-structure, modules, architecture, packaging]
    related_skills: [evidence-driven-delivery, test-driven-development]
---
