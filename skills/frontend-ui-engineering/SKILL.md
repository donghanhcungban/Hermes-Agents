...
description: "Build accessible, responsive, production-quality UIs."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [frontend, ui, accessibility, wcag, responsive, react, components]
    related_skills: [taste-skill, frontend-design, evidence-driven-delivery]
---
