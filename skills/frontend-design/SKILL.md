...
description: "Intentional visual design: palette, type, anti-slop."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [design, ui, typography, frontend, aesthetic, visual]
    related_skills: [taste-skill, redesign-skill, claude-design]
---
