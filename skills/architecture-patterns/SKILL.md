...
description: "Design backend boundaries with ports, adapters, and DDD."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [architecture, clean-architecture, hexagonal, ddd, microservices]
    related_skills: [api-and-interface-design, evidence-driven-delivery]
---
...
These architecture patterns compose well with CQRS command/query separation, saga orchestration for distributed transactions, and event-sourcing with domain events feeding an event store. Apply them when decomposing monoliths into services with clear bounded contexts.
