...
description: "Record technical decisions and maintain project docs."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [documentation, adr, decisions, technical-writing, architecture]
    related_skills: [evidence-driven-delivery, api-and-interface-design]
---
